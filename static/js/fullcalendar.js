...
function renderParsedFormat(parsedFormat, date1, date2, separator, isRTL) {
    ...
    if (parsedFormat.fakeFormatString == "MMMM[ ]YYYY") {
        renderedParts1[2] = parseInt(renderedParts1[2]) + 543;
        renderedParts2[2] = parseInt(renderedParts2[2]) + 543;
    }
    if (parsedFormat.fakeFormatString == "D[ ]MMM[ ]YYYY") {
        renderedParts1[4] = parseInt(renderedParts1[4]) + 543;
        renderedParts2[4] = parseInt(renderedParts2[4]) + 543;
    }
    if (parsedFormat.fakeFormatString == "D[ ]MMMM[ ]YYYY") {
        renderedParts1[4] = parseInt(renderedParts1[4]) + 543;
        renderedParts2[4] = parseInt(renderedParts2[4]) + 543;
    }        
...
var DayGrid = /** @class */ (function (_super) {
    ...
    DayGrid.prototype.renderSegPopoverContent = function (row, col, segs) {
        ...
        title = title.replace(title.substring(title.length - 4), parseInt(title.substring(title.length - 4)) + 543);
